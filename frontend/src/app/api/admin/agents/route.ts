...
const AGENTS: Record<string, {
  ...
  "generate-sites-daily": {
    order: 4,
    title: "Site builder",
    does: "Builds a demo site for qualified leads that have contact details and no website of their own.",
    matters: "672 businesses were waiting on this. Capped at 20 a day, because each build spends model tokens.",
  },
  "site-quality-gate": {
    order: 5,
    title: "Quality gate",
...
function readable(cron: string): string {
  const map: Record<string, string> = {
    ...
    "0 11 * * *": "Daily at 11:00 UTC (7am ET)",
