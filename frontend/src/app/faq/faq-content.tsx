...
const faqs = [
  ...
  { q: "Do you include hosting?", a: `Yes, one year of hosting is included in the price. After that, hosting starts at $${ENTRY.monthly}/month and includes maintenance and updates.` },
